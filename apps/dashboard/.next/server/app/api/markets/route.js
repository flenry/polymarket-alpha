"use strict";(()=>{var e={};e.id=820,e.ids=[820],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:e=>{e.exports=require("pg")},2629:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>c,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>l,serverHooks:()=>m,staticGenerationAsyncStorage:()=>_});var r={};s.r(r),s.d(r,{GET:()=>p});var o=s(5982),n=s(690),a=s(6585),i=s(6884),u=s(4077);async function p(e){let t=parseInt(e.nextUrl.searchParams.get("hours")??"24",10);if(isNaN(t)||t<1)return i.NextResponse.json({error:"Invalid hours parameter"},{status:400});t=Math.min(t,168);try{let e=`
      SELECT
        s.token_id,
